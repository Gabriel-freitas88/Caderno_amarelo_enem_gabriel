...
def renomear_questoes_simples():
    pasta = "133-180" # ATUALIZAR com o nome da pasta das questões que você vai arrumar 
    ...
    for i in range(47, 95+1):    # atualize seu for com o número da primeira imagem "parte_AlgumaCoisa.png" até o número da última imagem "parte_AlgumaCoisa.png" mais 1 da pasta
        antigo = f"parte_{i:03d}.png"
        #novo = f"questao-{i+24}-espanhol.png"  # faça uma conta: se a primeira pagina for 
        #novo = f"parte-{i+2}-ingles.png"
        novo = f"questao-{i+86}.png" # faça uma conta: se o i do teu for está em 2, e precisa virar questão 35, como você transforma 2 em 35? faça a conta e coloque dentro da concatenação
